## ----setup, include=FALSE------------------------------------------------------------------------------
require("knitr")
#xx opts_knit$set(root.dir = "/Users/kathi/Documents/Teaching/2020_Summer_School_iCLIP/")
...
# output file fasta
 ...
 BS_out_path <- paste(my_folder, rbp, paste0("BS_", rbp, ".RData"), sep="/")
...
# output file fasta
 ...
 BS_out_path <- paste0("/Users/kathi/Documents/Teaching/2020_Summer_School_iCLIP/data/BS_",rbp,".RData") 
...
## ----bw_file_path, eval=FALSE, include=FALSE-----------------------------------------------------------
## ##############################
## # paths to bigWig files (.bw)
## ##############################
## 
## # path to single replicates
## bw_1_plus_path <-
##   "/path/to/your/folder/crosslinks_<RBP>_sample1.plus.bw"
## 
## bw_1_minus_path <-
##   "/path/to/your/folder/crosslinks_<RBP>_sample1.minus.bw"
## 
...
## ----add_strand_others, include=FALSE------------------------------------------------------------------
strand(bw_2_plus) <- "+"
strand(bw_2_minus) <- "-"
...
## ----merge_crosslink_granges, include=TRUE, eval=FALSE-------------------------------------------------
...
## ----pureclip_path, eval=FALSE, include=TRUE-----------------------------------------------------------
...
## ----merged_path, eval=FALSE, include=TRUE-------------------------------------------------------------
...
## ----bs_out_file,  include=TRUE, eval=FALSE------------------------------------------------------------
## # set path to output file
## bs_out_file <- "/path/to/your/folder/binding_sites_<RBP>.bed"


## ----bs_export, include=TRUE, eval=FALSE---------------------------------------------------------------
...
## ----path_BS_RData, include=T, eval=F------------------------------------------------------------------
